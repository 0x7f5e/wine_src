        ...
        DWORD pitch_in, DWORD pitch_out, unsigned int w, unsigned int h)
{
    ...
    for (y = 0; y < h; y += 4)
    {
        ...
        for (x = 0; x < w; x += 4)
        {
            BYTE alphamap[16];
            for(i = 0; i < 8; i++){
                BYTE two_alpha_pixels = src_line[4 * x + i];
                alphamap[i * 2] = two_alpha_pixels & 0x0f;
                alphamap[i * 2 + 1] = two_alpha_pixels & 0xf0 >> 4;
            }
            ...
            dst_line[x] = cmap[bitmap & 0x00000003] | alphamap[0] << 12;
            dst_line[x + 1] = cmap[bitmap >> 2 & 0x00000003] | alphamap[1] << 12;
            dst_line[x + 2] = cmap[bitmap >> 4 & 0x00000003] | alphamap[2] << 12;
            dst_line[x + 3] = cmap[bitmap >> 6 & 0x00000003] | alphamap[3] << 12;
            dst_line1[x] = cmap[bitmap >> 8 & 0x00000003] | alphamap[4] << 12;
            dst_line1[x + 1] = cmap[bitmap >> 10 & 0x00000003] | alphamap[5] << 12;
            dst_line1[x + 2] = cmap[bitmap >> 12 & 0x00000003] | alphamap[6] << 12;
            dst_line1[x + 3] = cmap[bitmap >> 14 & 0x00000003] | alphamap[7] << 12;
            dst_line2[x] = cmap[bitmap >> 16 & 0x00000003] | alphamap[8] << 12;
            dst_line2[x + 1] = cmap[bitmap >> 18 & 0x00000003] | alphamap[9] << 12;
            dst_line2[x + 2] = cmap[bitmap >> 20 & 0x00000003] | alphamap[10] << 12;
            dst_line2[x + 3] = cmap[bitmap >> 22 & 0x00000003] | alphamap[11] << 12;
            dst_line3[x] = cmap[bitmap >> 24 & 0x00000003] | alphamap[12] << 12;
            dst_line3[x + 1] = cmap[bitmap >> 26 & 0x00000003] | alphamap[13] << 12;
            dst_line3[x + 2] = cmap[bitmap >> 28 & 0x00000003] | alphamap[14] << 12;
            dst_line3[x + 3] = cmap[bitmap >> 30 & 0x00000003] | alphamap[15] << 12;
        }
    }
}
